...
Extract the zip anywhere and run `OpenSpeaker.exe`. 
OpenSpeaker has automatic updates, you get prompted when an update is available or you can click the button in the top right.
